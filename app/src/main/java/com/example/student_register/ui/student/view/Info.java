package com.example.student_register.ui.student.view;
...
import com.example.student_register.ui.student.edit.EditStudent;
...
public class Info extends Fragment implements View.OnClickListener {
    ...
    // initializing NavController, receiving student position,
    // student view model to observe student data, edit student class and student id to know
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        // viewing student data via MVVM and observing student data from changes
    ...
    public void getPosition(int position){
        // receiving student position and give it forward to getAdapterPosition
        getAdapterPosition = position;
        Log.d(TAG, "onViewCreated: " + "Info: " +  getAdapterPosition);
    }

    private void updateStudent(){
        // using update student function to update a student
